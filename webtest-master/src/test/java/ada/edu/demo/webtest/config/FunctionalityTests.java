...
public class FunctionalityTests {
    ...
    @Test
@DisplayName("Test for finding users by firstname")
public void testFindUsersByFirstName(){
    String firstName = "Nigar";
    List <Student> addedStudents = Collections.singletonList(new Student());
when(studentRepository.findByName(firstName)).thenReturn(addedStudents);

List<Student> r = studentRepository.findByName(firstName);
